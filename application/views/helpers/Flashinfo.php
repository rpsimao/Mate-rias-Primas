...
class Application_View_Helper_Flashinfo extends Zend_View_Helper_Abstract
{
    ...
    {
        $html =  '<div class="'.$info["divclass"].' left-50 right-50" id="default_flash_message"><button type="button" class="close" data-dismiss="alert">×</button><p><i class="'.$info["iconclass"].'"></i><b> '.$info["msg"].'</b></p></div>';
